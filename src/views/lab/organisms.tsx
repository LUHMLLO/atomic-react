		...
		<main>
			...
			<div className='flex flex-col items-center justify-center p-nm aspect-square outline-dashed outline-neutral-800 rounded-md gap-5xs overflow-hidden'>
				<Breadcrumb>
					...
					<Dropdown text='Mark' flat>
						{/* <Link
						:text="i"
						v-for="i in ['Documents', 'Music', 'Pictures', 'Videos']" /> */}
					</Dropdown>
				</Breadcrumb>
			</div>
			...
			<div className='flex flex-col items-center justify-center p-nm aspect-square outline-dashed outline-neutral-800 rounded-md gap-5xs overflow-hidden'>
				<Collapsible text='Collapsible'>
					{/* <Text tag="p" :text="i.toString()" className="z-1" v-for="i in 6" /> */}
				</Collapsible>
			</div>

			<div className='flex flex-col items-center justify-center p-nm aspect-square outline-dashed outline-neutral-800 rounded-md gap-5xs overflow-hidden'>
				<Collapsible text='Collapsible flat' flat>
					{/* <Text tag="p" :text="i.toString()" className="z-1" v-for="i in 6" /> */}
				</Collapsible>
			</div>

			<div className='relative flex flex-col items-center justify-center p-nm aspect-square outline-dashed outline-neutral-800 rounded-md gap-5xs overflow-hidden'>
